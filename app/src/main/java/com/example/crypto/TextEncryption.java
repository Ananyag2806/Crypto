    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent temp=new Intent(TextEncryption.this,Encoder.class);
                startActivity(temp);
            }
        } );
        ...
        dec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent temp=new Intent(TextEncryption.this,Decoder.class);
                startActivity(temp);
            }
        });
        vf=findViewById(R.id.vf);
       // int images[]={R.drawable.bellaso_cipher,R.drawable.caeser_cipher_encryption,}
